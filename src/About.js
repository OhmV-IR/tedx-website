    ...
    return (
        <div id="aboutRoot">
            ...
            and we invite everyone to engage with ideas and activate them in your community.<br></br><br></br>
                ...
                Follow TED on <a className="linkUnderline" href="http://www.facebook.com/TED">Facebook</a>, <a className="linkUnderline" href="https://instagram.com/ted">Instagram</a>, <a className="linkUnderline" href="https://www.linkedin.com/company/ted-conferences">LinkedIn</a>, 
