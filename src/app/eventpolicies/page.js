...
function EventPolicies() {
    ...
    return (
        ...
        `}</style>
        {isMobile
        ?    <div id="policies"><h1 id="policiesTitleMobile">Event policies</h1>
            <h3 id="firstRuleMobile">Please abide by all rules set out by TED as can be seen here: <a href="https://conferences.ted.com/policies" className="link">TED Policies</a></h3>
