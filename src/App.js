    ...
    function ToggleSiteMenu(){
        if(siteMenuEnabled === true){
            ...
            for(let i = 0; i < element.children.length; i++){
                ...
                currentMenuItem.children.item(0).style.animation = "menu-open".concat(i.toString(), "icon", " 0.75s linear 0s 1 normal");
                currentMenuItem.children.item(1).style.animation = "menu-open".concat(i.toString(), "label", " 0.75s linear 0s 1 normal");
            }
        }
